...
<div class="crumbs">
    ...
    <a href="/information/jrtt.html" class="crumbs-add">民众头条</a>
</div>
...
<div class="top-news container">
    ...
    <?php if(count($jrtt_list)): ?>
        ...
        <a href="/information/jrtt_detail/<?php echo $v['id']; ?>.html" class="top-news-content-li">
...
<script>
    ...
    $("#pagination").pagination({
      ...
      callback: function(current) {
        window.location.href = "/information/jrtt/"+current+".html";
      }
    });
</script>
</html>
