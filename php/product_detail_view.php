...
<div class="crumbs">
    ...
    <a href="#" class="crumbs-add"><?php echo $category_name; ?> · <?php echo $product_detail_info['name']; ?></a>
</div>

<div class="container product-detail">
    <a class="product-head">
        <img class="product-head-img" src="<?php echo $product_detail_info['pic_path']; ?>" alt="">
        <div class="product-head-info">
            <div class="box-title">
                <?php echo $category_name; ?> · <?php echo $product_detail_info['name']; ?>
                <p class="box-title-sub">
                    <?php echo $product_detail_info['description']; ?>
                </p>
            </div>
            <div class="price">
                价格：<span class="red"><?php echo $product_detail_info['price']; ?>元/<?php echo $product_detail_info['time']; ?>天</span>
            </div>
        </div>
    </a>
    <div class="product-content">
        <?php echo $product_detail_info['content']; ?>
    </div>
</div>
