...
<div class="page-article">
    <div class="page-article-content">
       <div class="page-article-content-title2">
            ...
            <div class="sub">
                <div class="date"><?php echo date("Y-m-d H:i",$information_detail['timestamp']); ?></div>
                <div class="line"></div>
                <div class="author">作者：<?php echo $information_detail['author']; ?></div>
                <div class="line"></div>
                <div class="from">来源：<?php echo $information_detail['source']; ?></div>
            </div>
        </div>
        ...
        <div class="page-article-content-nav">
            <div class="prev">
                <span>上一篇：</span>
                <a class="link" href="/information/jrtt_detail/<?php echo $prev['id']; ?>.html"><?php echo $prev['title']; ?></a>
            </div>
            <div class="next">
                <span>下一篇：</span>
                <a class="link" href="/information/jrtt_detail/<?php echo $next['id']; ?>.html"><?php echo $next['title']; ?></a>
            </div>
        </div>
    </div>
