...
<html>
	...
	<body class="bc_12">
		<div class="pr">
			<img src="/assets/home/img1/30.jpg" class="pf bottom_0 top_0 left_0 right_0 wp hp" alt="" />
			<div class="pf bottom_0 top_0 left_0 right_0 wp hp oa">
				<!-- <div class="bc_41 tac" style="padding: .2rem 0 .1rem 0;">
					<img src="/assets/home/img1/19.jpg" class="" style="width:100%;" alt="" />
				</div> -->
				<div class="tac" style="padding: 2.5rem 0 2rem 0;">
					<img src="/assets/home/img1/<?php echo $color;?>.png" style="width:20%;" alt="" />
				</div>
				<div class="fwb tac c_41" style="font-size: 2rem;"><?php echo $word;?></div>
				<div class="bc_41 c_11 tac w50p shawdow_box1 fwb fs22" style="padding: .8rem 0;border-radius: .5rem;margin:2rem auto 3rem;" onclick="location.href = '<?php echo $url;?>'">关闭</div>
